<div class="btn-group">
    ...
    <ul class="dropdown-menu custom-dropdown-menu" role="menu">
        ...
        <li><a href="#" class="delete_confirmation" data-toggle="modal" data-target="#deleteModal_{{$id}}" data-action="{{ route('roles.destroy', $id) }}"><i class="fa fa-trash fa-fw"></i>@lang('admin.delete')</a></li>
    </ul>
</div>
