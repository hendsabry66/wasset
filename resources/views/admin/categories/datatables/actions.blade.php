<div class="btn-group">
    ...
    <ul class="dropdown-menu custom-dropdown-menu" role="menu">
        <li><a href="{{ route('categories.show', $id) }}"><i class="fa fa-eye fa-fw"></i>@lang('admin.show')</a></li>
        <li><a href="{{ route('categories.edit', $id) }}"><i class="fa fa-edit fa-fw"></i>@lang('admin.edit')</a></li>
        <li><a href="#" class="delete_confirmation" data-toggle="modal" data-target="#deleteModal_{{$id}}" data-action="{{ route('categories.destroy', $id) }}"><i class="fa fa-trash fa-fw"></i>@lang('admin.delete')</a></li>
    </ul>
</div>
    ...
    <div class="modal-dialog" style="margin-top:50px;">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="{{ route('categories.destroy', $id) }}" class="ajaxForm" method="post" id="delete_modal">
                    @method('delete')
                    @csrf
