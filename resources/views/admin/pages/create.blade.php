                ...
                <div class="card">
                    ...
                    <div class="card-content collpase show">
                        <div class="card-body">
                            ...
                            <form class="form form-horizontal ajaxForm" action="{{route('pages.store')}}" method="post" enctype="multipart/form-data">
                               @csrf
                                <div class="form-body">
                                    <h4 class="form-section"><i class="ft-user"></i>  @lang('admin.addPage') </h4>

                                  @include('admin.pages.form')

                                </div>
                                <div class="form-actions ">
                                    <a href="{{route('pages.index')}}" class="btn btn-warning mr-1">
