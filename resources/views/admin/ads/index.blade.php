                    ...
                    <div class="card-head">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="btn-group">
                                        <a href="{{ route('ads.create') }}" class="btn btn-success">@lang('admin.addNewAd') <i class="fa fa-plus"></i></a>

                                        <a href="#" class="bulk_delete_confirmation btn btn-danger" id="sample_editable_1_new" data-toggle="modal" data-target="#bulkDeleteModal" data-action="{{ route('ads.bulk-delete') }}">
        ...
        <div class="modal-dialog" style="margin-top:50px;">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="{{ route('ads.bulk-delete') }}"  class="ajaxForm" method="post" id="bulk_delete_modal">
                        @csrf
