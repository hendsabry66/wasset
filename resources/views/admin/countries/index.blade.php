                    ...
                    <div class="card-head">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="btn-group">
                                        <a href="{{ route('countries.create') }}" class="btn btn-success">@lang('admin.addNewCountry') <i class="fa fa-plus"></i></a>
        ...
        <div class="modal-dialog" style="margin-top:50px;">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="{{ route('countries.bulk-delete') }}" method="post" class="ajaxForm" id="bulk_delete_modal">
                        @csrf
