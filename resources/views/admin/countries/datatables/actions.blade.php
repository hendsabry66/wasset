<div class="btn-group">
    ...
    <ul class="dropdown-menu custom-dropdown-menu" role="menu">
        <li><a href="{{ route('countries.show', $id) }}"><i class="fa fa-eye fa-fw"></i>@lang('admin.show')</a></li>
        <li><a href="{{ route('countries.edit', $id) }}"><i class="fa fa-edit fa-fw"></i>@lang('admin.edit')</a></li>
    ...
    <div class="modal-dialog" style="margin-top:50px;">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="{{ route('countries.destroy', $id) }}" method="post" class="ajaxForm" id="delete_modal">
                    @method('delete')
                    @csrf
