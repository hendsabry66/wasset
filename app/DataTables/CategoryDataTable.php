...
class CategoryDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable
            ->escapeColumns([])
            ->addColumn('check', 'admin.categories.datatables.check')
            ->editColumn('name', function ($q) {
                return "<a href='".route('categories.show', $q->id)."'>".$q->getTranslation('name','en')." - ".$q->getTranslation('name','ar')."</a>";
            })
            ...
            ->addColumn('actions', 'admin.categories.datatables.actions');
